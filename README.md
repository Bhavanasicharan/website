...
<head>
    ...
    <title><b>Welcome to CHARAN MEES</b></title>
    <style>
        body {
            ...
            padding: 0;
            text-align: center;
            background-image: url('resturant.png.png');
...
<body>
    ...
    <!-- Header Section -->
    <div class="banner">
        <h1><b>Welcome to CHARAN MEES</b></h1>
    ...
    <div class="welcome-section">
        <h2>ABOUT CHARAN MESS </h2>
        <p>At CHARAN MESS, Everything that we bring you is pure,</p>
        <P>delicious and authentic.</P>
        <P> At  CHARAN MESS, we prepare only using the finest ingredients, following time-tested methods.</P>
        <P> Experience a perfect blend of timeless tradition and innovation in every bite.</p>
   

    <!-- Food Images Section -->
    <div class="food-images">
        <img src="D1.png.jpg" alt="Delicious Food 1">
        <img src="D2.png.jpg" alt="Delicious Food 2">
    </div>
    <br>
    <br>
    <br>
    ...
    <!-- Footer Section -->
    <footer>
        <p><b>&copy; DESIGNED BY: CHARAN REDDY B (24009453))</b></p>
    </footer>
</body>
</html>
...
<body>
    ...
    <div class="banner">
        ...
        <p>The team Charan Resturant success</p>
    </div>
    ...
    <div class="admin-section">
        ...
        <div class="admin-grid">
            <div class="admin-card">
                <img src="C.png.png" alt="Admin 1">
                <h3>CHARAN REDDY B</h3>
                <p>C.E.O</p>
                <p>EMAIL:charan757@gmail.com</p>
            </div>
            <div class="admin-card">
                <img src="VKT.png.png" alt="Admin 2">
                <h3>VENKATESH</h3>
                <p>Head Chef</p>
                <p>EMAIL:venkatesh@gmail.com</p>
            </div>
            <div class="admin-card">
                <img src="DH.png.png" alt="Admin 3">
                <h3>DHANUSH</h3>
                <p>CHEIF GUEST</p>
                <p>EMAIL:dhanush@gmail.com</p>
            </div>
            <div class="admin-card">
                <img src="SR.png.png" alt="Admin 4">
                <h3>SAI RAM</h3>
                <p>MARKETING MANAGER</p>
                <p>sairam@gmail.com</p>
            </div>
            <div class="admin-card">
                <img src="DHH.png.png" alt="Admin 5">
                <h3>DHANUSH C</h3>
                <p>FINANCE MANAGER</p>
                <p>EMAIL:charan@gmail.com</p>
            </div>
            <div class="admin-card">
                <img src="CT.png.png" alt="Admin 5">
                <h3>RAHUL ROYAL</h3>
...
<div class="contact-section">  
    ...
    <div class="contact-details">
        ...
        <p>9908061390</p>
        <h2>Email</h2>
        <p><a href="mailto:charanmess">charanmess@gmail.com</a></p>
        <h3>Developed and designed by CHARAN REDDY B </h3>
    </div>
```
# OUTPUT:
![alt text](<Screenshot 2024-12-21 213559.png>)
![alt text](<Screenshot 2024-12-21 213622.png>)
![alt text](<Screenshot 2024-12-21 213632.png>)
![alt text](<Screenshot 2024-12-21 213643.png>)
![alt text](<Screenshot 2024-12-21 213652.png>)
# RESULT:
